...
![Hystrix Home](https://github.com/rajeshjaava/springcloud-netflix-oss-poc/blob/master/hystrix-dashboard/hystrix_home.png?raw=true)
...
![Hystrix Home](https://github.com/rajeshjaava/springcloud-netflix-oss-poc/blob/master/hystrix-dashboard/hystrix_A.png?raw=true)

This willa llow you to monitor one service. In order to monitor several services at one in the Hystrix Dashboard we need to use an agregator like [Turbine](https://github.com/rajeshjaava/springcloud-netflix-oss-poc/tree/master/turbine).
