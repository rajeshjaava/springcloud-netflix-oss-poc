...
```json
{
  ...
  "configService:https://github.com/rajeshjaava/netflix-oss-example-config-repo/serviceB-local.properties": {
    "default.message": "From local file"
  },
  "configService:https://github.com/rajeshjaava/netflix-oss-example-config-repo/serviceB.properties": {
